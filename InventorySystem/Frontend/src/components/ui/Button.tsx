    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-gradient-to-r from-indigo-600 to-violet-600 text-white hover:from-indigo-500 hover:to-violet-500 shadow-md shadow-indigo-500/10 hover:shadow-lg hover:shadow-indigo-500/20 focus:ring-indigo-500": variant === "primary",
            ...
            "bg-gradient-to-r from-rose-600 to-red-600 text-white hover:from-rose-500 hover:to-red-500 shadow-md shadow-rose-500/10 hover:shadow-lg hover:shadow-rose-500/20 focus:ring-red-500": variant === "danger",
