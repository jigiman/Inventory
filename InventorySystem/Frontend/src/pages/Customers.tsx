      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          {detailLoading ? (
            ...
            <div className="overflow-x-auto border border-slate-200/50 dark:border-slate-800/60 rounded-2xl bg-white dark:bg-[#070b13]">
              {detailTab === 'sales' && (
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80">
              {filteredCustomers.map((cust) => (
                <tr key={cust.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-700 dark:text-slate-300">{cust.contactPerson || '-'}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {cust.phone ? (
                  ...
                  <td className="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                    <button
                      ...
                      className="p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-slate-200 rounded-lg cursor-pointer transition-colors"
                      title="Edit"
                    >
                      <Edit2 size={14} />
                    </button>
